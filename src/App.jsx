...
function App() {
  ...
  return (
      <>
        <div className="h-screen w-full bg-linear-to-br from-amber-50 via-rose-50 to-teal-50 flex flex-col gap-y-6 items-center justify-center p-4 relative overflow-hidden pointer-events-none -z-50">
